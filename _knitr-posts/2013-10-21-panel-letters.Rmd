...
```{r panel_letters5, fig.width=6, fig.height=3}
...
```{r panel_letters1, fig.width=6, fig.height=3}
par(mfrow = c(1, 2), mar = c(2, 2.5, 0, 0))
for(i in 1:2) {
  plot(1)
...
```{r panel_letters2, fig.width=6, fig.height=3}
...
```{r panel_letters3, fig.width=6, fig.height=3}
...
```{r panel_letters4, fig.width=6, fig.height=3}
