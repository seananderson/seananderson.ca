...
dplyr is [Hadley Wickham's](http://had.co.nz/) re-imagined plyr package (with underlying C++ secret sauce co-written by [Romain Francois](http://blog.r-enthusiasts.com/)). plyr 2.0 if you will. It does less than plyr, but what it does it does more elegantly and much more quickly.
